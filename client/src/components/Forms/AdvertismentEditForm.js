...
const AdvertismentForm = ({ advertismentData })=>{
    console.log(advertismentData);

    const classes = useStyles();

    const [ad_name, setad_name] = useState(advertismentData.ad_name);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        await axios.put("http://localhost:5000/api/ad/update/" + advertismentData._id, formdata);
